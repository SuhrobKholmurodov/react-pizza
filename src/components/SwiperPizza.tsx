  ...
  return (
    <div className='mx-auto relative'>
      <Swiper
        ...
        className='mySwiper rounded-lg sm:rounded-[0] relative z-10 w-full'
        slidesPerView={1}
      >
        {promotionalItems.map(el => (
          <SwiperSlide
            key={el.id}
            className='dark:bg-neutral-900 px-[180px] py-10 shadow-md flex flex-col items-center justify-between gap-6 relative sm:px-[30px] sm:py-4 sm:gap-2'
          >
